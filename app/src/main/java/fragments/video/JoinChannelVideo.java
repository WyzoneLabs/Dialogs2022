...
public class JoinChannelVideo extends BaseFragment implements View.OnClickListener
{
    ...
    {
        return inflater.inflate(R.layout.fragment_joinchannel_video, container, false);
    }
    ...
    private void joinChannel(String channelId)
    {
        ...
        int size = globalSettings.getVideoEncodingDimensionObject().width / 6;
        int height = globalSettings.getVideoEncodingDimensionObject().height;
...
//        engine.addVideoWatermark(Constant.WATER_MARK_FILE_PATH, watermarkOptions);
    ...
    private final IRtcEngineEventHandler iRtcEngineEventHandler = new IRtcEngineEventHandler()
    {
        ...
        public void onJoinChannelSuccess(String channel, int uid, int elapsed)
        {
            ...
            showLongToast(String.format(Locale.getDefault(),"onJoinChannelSuccess channel %s uid %d", channel, uid));
            myUid = uid;
            joined = true;
            handler.post(() -> {
        ...
        public void onUserJoined(int uid, int elapsed)
        {
            ...
            showLongToast(String.format(Locale.getDefault(),"user %d joined!", uid));
