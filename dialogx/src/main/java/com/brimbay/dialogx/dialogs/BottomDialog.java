...
import com.brimbay.dialogx.interfaces.DialogXStyle;
...
import com.brimbay.dialogx.interfaces.ScrollController;
import com.brimbay.dialogx.util.BottomDialogTouchEventInterceptor;
import com.brimbay.dialogx.util.TextInfo;
import com.brimbay.dialogx.util.views.BlurView;
import com.brimbay.dialogx.util.views.BottomDialogScrollView;
...
public class BottomDialog extends BaseDialog {
    ...
    public class DialogImpl implements DialogConvertViewInterface {
        ...
        private final ViewTreeObserver.OnGlobalLayoutListener onContentViewLayoutChangeListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
    ...
    public BottomDialog setBackgroundAlpha(@IntRange(from = 0,to = 255) int alpha) {
