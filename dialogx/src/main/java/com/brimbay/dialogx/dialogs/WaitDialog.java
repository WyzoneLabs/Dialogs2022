package com.brimbay.dialogx.dialogs;
...
import com.brimbay.dialogx.interfaces.DialogConvertViewInterface;
import com.brimbay.dialogx.interfaces.DialogLifecycleCallback;
import com.brimbay.dialogx.interfaces.OnBackPressedListener;
import com.brimbay.dialogx.interfaces.OnBindView;
import com.brimbay.dialogx.interfaces.ProgressViewInterface;
import com.brimbay.dialogx.util.TextInfo;
import com.brimbay.dialogx.util.views.BlurView;
import com.brimbay.dialogx.util.views.DialogXBaseRelativeLayout;
import com.brimbay.dialogx.util.views.MaxRelativeLayout;
import com.brimbay.dialogx.util.views.ProgressView;
...
public class WaitDialog extends BaseDialog {
    ...
    public class DialogImpl implements DialogConvertViewInterface {
        ...
        public void refreshView() {
            ...
            if (style.overrideWaitTipRes() != null) {
                ...
                if (blurView != null) {
                    blurView.setOverlayColor(backgroundColor == -1 ? getResources().getColor(overrideBackgroundColorRes,null) : backgroundColor);
                    blurView.setUseBlur(style.overrideWaitTipRes().blurBackground());
                    blurView.setAlpha(backgroundAlpha);
                }
                ...
                txtInfo.setTextColor(getResources().getColor(overrideTextColorRes,null));
                progressView.setColor(getResources().getColor(overrideTextColorRes,null));
            } else {
                if (isLightTheme()) {
                    if (blurView != null) {
                        blurView.setOverlayColor(backgroundColor == -1 ? getResources().getColor(R.color.dialogxWaitBkgDark, null) : backgroundColor);
                        blurView.setAlpha(backgroundAlpha);
                    }
                    ...
                    if (blurView != null) {
                        blurView.setOverlayColor(backgroundColor == -1 ? getResources().getColor(R.color.dialogxWaitBkgLight, null) : backgroundColor);
                        blurView.setAlpha(backgroundAlpha);
                    }
    ...
    public WaitDialog setBackgroundAlpha(@IntRange(from = 0,to = 255) int alpha) {
