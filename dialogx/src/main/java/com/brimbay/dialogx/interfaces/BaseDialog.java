package com.brimbay.dialogx.interfaces;

import static com.brimbay.dialogx.DialogX.DEBUGMODE;
...
import com.brimbay.dialogx.impl.ActivityLifecycleImpl;
import com.brimbay.dialogx.impl.DialogFragmentImpl;
import com.brimbay.dialogx.util.ActivityRunnable;
import com.brimbay.dialogx.util.DialogXFloatingWindowActivity;
import com.brimbay.dialogx.util.TextInfo;
import com.brimbay.dialogx.util.WindowUtil;
...
public abstract class BaseDialog {
    ...
    public static void init(Context context) {
        ...
        ActivityLifecycleImpl.init(context, BaseDialog::initActivityContext);
    }
    ...
    public View createView(int layoutId) {
        if (getContext() == null) {
            error("DialogX is not initialized. \\nPlease check whether the initialization operation is performed before" +
                    " starting the dialog box, and use the following code to initialize:\\nDialogX.init(context);\\n\\nIn addition, " +
                    "it is recommended that you check the DialogX documentation for use: https:github.comkongzueDialogX");
            return null;
        }
